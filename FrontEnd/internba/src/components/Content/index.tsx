...
import AddNews from "./AddNews.module.scss";
...
function Content() {
  ...
  return (
    <Fragment>
      ...
      <div className={Card.newsCard}>
        <div className={News.newsUser}>
          <div className={News.userWrapper}>
            <div className={News.userAvatar}>
              <img
                src="https://lh3.googleusercontent.com/a-/AOh14GjznYLHNnOotz1OvIAbOggupvj7hCWNvHPm0tqG6w=s96-c"
                alt=""
              />
            </div>
            <div>
              <div className={News.userName}>Tai Tran</div>
              <div className={News.userTime}>12 hours ago</div>
            </div>
          </div>
          ...
          <div className={News.feedActionWrapper}>
            ...
            <div className={News.action}>
              <span
                ...
                className={`${News["emotionIcon"]} ${News["anticon"]}`}
              ></span>
              <span className={News.emotionTitle}>Comment</span>
            </div>
            <div className={News.action}>
              <span
                role="img"
                ...
                className={`${News["emotionIcon"]} ${News["anticon"]}`}
              ></span>
              <span className={News.emotionTitle}>Share</span>
            </div>
          </div>
        </div>

        <div className={News.feedComment}>
          <div className={Comment.commentWrapper}>
            <img
            ...
            <div>
              <div className={Comment.commentBox}>
                <div className={Comment.commentTitle}>Huong Lan</div>
                <div className={Comment.commonDescription}>Nice</div>
                <div className={`${Comment.commentEmotion} ${Comment.active}`}>
                  <img
              ...
              <div className={Comment.commentReaction}>
                <span>Like</span>
                <span>Reply</span>
          ...
          <div className={Comment.commentWrapper}>
            ...
            <div>
              <div className={Comment.commentBox}>
                <div className={Comment.commentTitle}>Manh Cuong</div>
                <div className={Comment.commonDescription}>Good job</div>
                <div className={`${Comment.commentEmotion} ${Comment.active}`}>
                  <img
                    src="https://winka-social-network.netlify.app/static/media/likeCount.5d3594a6.svg"
                    alt=""
