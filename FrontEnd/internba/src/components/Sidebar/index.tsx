            ...
            <button className={Button.button}>
              <div className={sidebar.itemWrapper}>
                <img
                  ...
                  alt=""
                  className={sidebar.sidebarItemIcon}
                />
